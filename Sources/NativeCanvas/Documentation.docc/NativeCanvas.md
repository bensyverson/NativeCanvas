...
`CGImage` output backed by CoreGraphics. Templates declare a typed parameter schema so that
host applications can drive dynamic graphics — titles, lower-thirds, data visualisations — with
